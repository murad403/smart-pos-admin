    ...
    return (
        <div className="space-y-6 pb-10">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                    <h1 className="text-[32px] font-bold tracking-tight text-slate-900">USER & ACCESS MANAGEMENT</h1>
            ...
            <div className="rounded-[24px] border border-slate-100 bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.02)] sm:p-8">
                <div className="mb-8 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-[12px] font-bold uppercase tracking-wider text-blue-600">USER & ACCESS MANAGEMENT</h2>
                    </div>
                    <div className="flex items-center gap-2 rounded-lg border border-slate-200 px-3 py-1.5">
                        <input type="checkbox" className="rounded border-slate-300 text-blue-600 focus:ring-blue-500" />
                        <span className="text-[11px] font-bold uppercase tracking-wider text-slate-500">MANAGEMENT CONSOLE</span>
                    </div>
                </div>

                <p className="mb-6 text-[14px] text-slate-500">Reset or update passwords for Admins and Staff members.</p>
